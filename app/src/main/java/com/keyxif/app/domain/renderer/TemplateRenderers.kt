...
class ClassicFrameRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(24, 25, 24), LogoAnchor.Start)
        ...
        val labelPaint = medium(scaled(h * 0.012f, settings), Color.rgb(96, 98, 94))
        val valuePaint = medium(scaled(h * 0.0165f, settings), Color.rgb(20, 21, 20))
...
class MinimalCaptionRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        val pad = w * 0.045f
        val titlePaint = medium(scaled(h * 0.024f, settings), Color.rgb(24, 25, 24))
        val bodyPaint = regular(scaled(h * 0.0155f, settings), Color.rgb(78, 80, 76))
        ...
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(28, 29, 28), LogoAnchor.End)
...
class PosterMarginRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        val titlePaint = medium(scaled(h * 0.028f, settings), Color.rgb(24, 24, 23))
        val specPaint = regular(scaled(h * 0.015f, settings), Color.rgb(70, 72, 69))
        val signaturePaint = medium(scaled(h * 0.014f, settings, settings.nicknameEmphasis), Color.rgb(88, 86, 80)).apply {
            textAlign = Paint.Align.RIGHT
        }
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(28, 28, 27), LogoAnchor.End)
...
class SideSpecRailRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        canvas.drawRect(rail, CanvasRenderUtils.paint(Color.rgb(250, 250, 247), 1f))
        canvas.drawRect(rail.left, 0f, rail.left + 2f, h, CanvasRenderUtils.paint(Color.rgb(217, 218, 214), 1f))
        val pad = w * 0.028f
        ...
        val titlePaint = medium(scaled(h * 0.024f, settings), Color.rgb(24, 25, 24))
        val labelPaint = regular(scaled(h * 0.0115f, settings), Color.rgb(96, 98, 94))
        val valuePaint = medium(scaled(h * 0.0155f, settings), Color.rgb(32, 33, 32))
...
class TopNameplateRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        canvas.drawRect(header, CanvasRenderUtils.paint(Color.rgb(250, 250, 247), 1f))
        val pad = w * 0.035f
        ...
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(24, 25, 24), LogoAnchor.Start)
        val titlePaint = medium(scaled(h * 0.025f, settings), Color.rgb(22, 23, 22))
        val bodyPaint = regular(scaled(h * 0.0145f, settings), Color.rgb(72, 74, 70))
        ...
        canvas.drawRect(0f, header.bottom - 2f, w, header.bottom, CanvasRenderUtils.paint(Color.rgb(219, 220, 216), 1f))
    }
...
class MuseumMatRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(24, 24, 23), LogoAnchor.End)
        val titlePaint = medium(scaled(h * 0.026f, settings), Color.rgb(31, 31, 29))
        val bodyPaint = regular(scaled(h * 0.015f, settings), Color.rgb(80, 80, 75))
        val labelPaint = regular(scaled(h * 0.012f, settings), Color.rgb(110, 106, 98))
...
class CompactTicketRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        drawRoundRect(canvas, ticket, ticket.height() * 0.18f, Color.rgb(251, 250, 246))
        ...
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(27, 28, 27), LogoAnchor.Start)
        val titlePaint = medium(scaled(h * 0.0195f, settings), Color.rgb(22, 23, 22))
        val bodyPaint = regular(scaled(h * 0.013f, settings), Color.rgb(74, 76, 72))
...
class CleanSignatureRenderer : TemplateRenderer {
    ...
    override fun draw(canvas: Canvas, bounds: RectF, info: KeyboardBuildInfo, assets: RenderAssets, settings: AppSettings) {
        ...
        val logoActual = drawLogoIfPresent(canvas, logoBox, assets, Color.rgb(20, 21, 20), LogoAnchor.End)
