...
class AppSettingsRepository(
    ...
    suspend fun update(transform: (AppSettings) -> AppSettings) {
        context.keyxifSettingsDataStore.edit { preferences ->
            ...
            preferences[Keys.USE_PALETTE_COLOR_FOR_CARD_BACKGROUND] = next.usePaletteColorForCardBackground
            preferences[Keys.PALETTE_BACKGROUND_COLOR_INDEX] = next.paletteBackgroundColorIndex
    ...
    private fun decode(preferences: Preferences): AppSettings {
        return AppSettings(
            ...
            textScale = preferences[Keys.TEXT_SCALE] ?: 1.12f,
            ...
            usePaletteColorForCardBackground = preferences[Keys.USE_PALETTE_COLOR_FOR_CARD_BACKGROUND] ?: false,
            paletteBackgroundColorIndex = preferences[Keys.PALETTE_BACKGROUND_COLOR_INDEX] ?: 0,
    ...
    private fun AppSettings.normalized(): AppSettings {
        return copy(
            ...
            textScale = textScale.coerceIn(0.9f, 1.55f),
    ...
    private object Keys {
        ...
        val USE_PALETTE_COLOR_FOR_CARD_BACKGROUND = booleanPreferencesKey("use_palette_color_for_card_background")
        val PALETTE_BACKGROUND_COLOR_INDEX = intPreferencesKey("palette_background_color_index")
