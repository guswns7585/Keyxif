...
data class PhotoItem(
    ...
    val renderStyle: PhotoRenderStyle = PhotoRenderStyle(),
...
data class AppSettings(
    ...
    val paletteAnalysisMode: PaletteAnalysisMode = PaletteAnalysisMode.AutoCenter,
...
fun PaletteAnalysisMode.displayName(): String = when (this) {
    PaletteAnalysisMode.AutoCenter -> "자동중앙"
    PaletteAnalysisMode.RectSelection -> "사각형으로 영역 지정"
    PaletteAnalysisMode.PaintedMask -> "직접 칠하기"
}

fun defaultPaletteAnalysisRect(): NormalizedRect = NormalizedRect(
    left = 0.15f,
    top = 0.39f,
    right = 0.85f,
    bottom = 0.61f,
